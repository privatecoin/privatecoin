...
uint256 const hashGenesisBlock("0xhash");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "bbbbbbb";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x29c91cd5fc8c2489d919f9e2fe270ce7ef985907c3d78125bfe63a8db472922e"));
