...
uint256 const hashGenesisBlock("0xa3cf7ed9e375d93e89b877bee14d92415be6609b6fcfa1317f350f3510248058");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        // hashGenesisBlock = uint256("0xa3cf7ed9e375d93e89b877bee14d92415be6609b6fcfa1317f350f3510248058"); // TODO: get this to compile so testnet works
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0xfeadfb52525a8495a0470b1399deb811392d4128db7adc795ffd70665672a96e"));
        block.print();
