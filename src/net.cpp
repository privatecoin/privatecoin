...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Privatecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"privatecointools.com", "dnsseed.privatecointools.com"},
    {"privatecoinpool.org", "dnsseed.privatecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"privatecointools.com", "testnet-seed.privatecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Privatecoin is probably already running."), addrBind.ToString().c_str());
        else
