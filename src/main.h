...
static const int64 MAX_MONEY = 84000000 * COIN; // Privatecoin: maximum of 840k coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // Privatecoin: 576 blocks found a day. Priority cutoff is 1 privatecoin day / 250 bytes.
    }
